...
const channel = pusher.subscribe(`chat.${document.getElementById('channel_id').value}`);
...
channel.bind('message', function(event) {
    ...
    const userIcon = msg.user?.profile_image_url || null;
    const createdAt = msg.created_at;

    // TODO: To prevent double chat, fix better
    if (document.getElementById('current_user_id').value === userId) {
        return
    }
